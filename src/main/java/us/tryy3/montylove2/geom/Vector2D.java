...
import us.tryy3.montylove2.geom.direction.Vector2DDirection;
import us.tryy3.montylove2.geom.vector.Vector2DIterator;
...
public class Vector2D implements Iterable<Vector2D>
{
    ...
    {
        int y = world.getHighestBlockYAt(getBlockX(), getBlockZ());
        return to3D(y);
    }
