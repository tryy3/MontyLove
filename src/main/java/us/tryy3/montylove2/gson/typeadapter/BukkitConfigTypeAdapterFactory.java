...
public class BukkitConfigTypeAdapterFactory implements TypeAdapterFactory
{
    ...
    public static class BukkitConfigTypeAdapter<T> extends TypeAdapter<T>
    {
        ...
        private static final Type BUKKIT_SERIAL_TYPE = new TypeToken<HashMap<String, String>>() {}.getType();
        ...
        {
            Map<String, Object> map = gson.fromJson(reader, BUKKIT_SERIAL_TYPE);
            map.put(ConfigurationSerialization.SERIALIZED_TYPE_KEY, map.remove(SERIALIZED_TYPE_KEY));
